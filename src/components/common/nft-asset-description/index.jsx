...
const NftAssetDescription = () => {
  return (
    <div className="bg-neutral-n-0 border-solid drop-shadow-md rounded-md p-7 mt-2.5">
      ...
      <p className="text-neutral-n-800 text-sm font-semibold leading-[1.125rem] pb-4">Variation Apes Socials</p>
