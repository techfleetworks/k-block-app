...
export default function TokensPagination({
  pageSize,
  pageIndex,
  pageCount,
  onPageChange,
      ...
      <div className="flex items-center">
        <button
          className={`px-2 py-1 rounded flex items-center ${
            pageIndex === 0 && "text-neutral-n-500"
          }`}
        ...
        <button
          className={`px-2 py-1 rounded flex items-center text-primary-b-500 text-sm leading-5 font-normal ${
            pageIndex === pageCount - 1 && "text-primary-b-500"
          }`}
          onClick={() => onPageChange(pageIndex + 1)}
